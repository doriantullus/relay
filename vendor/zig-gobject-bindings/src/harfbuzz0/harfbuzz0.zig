...
extern fn hb_face_is_immutable(p_face: *const harfbuzz.face_t) harfbuzz.bool_t;
...
///
/// <note>Note: The glyph shape fetched via the `harfbuzz.fontDrawGlyph`
...
/// then it is the client program's responsibility to destroy `ft_face`
/// after the `harfbuzz.font_t` font object has been destroyed.
///
...
/// A virtual method for the `harfbuzz.font_funcs_t` of an `harfbuzz.font_t` object.
pub const font_paint_glyph_func_t = *const fn (p_font: *harfbuzz.font_t, p_font_data: ?*anyopaque, p_glyph: harfbuzz.codepoint_t, p_paint_funcs: *harfbuzz.paint_funcs_t, p_paint_data: ?*anyopaque, p_palette_index: c_uint, p_foreground: harfbuzz.color_t, p_user_data: ?*anyopaque) callconv(.c) void;
...
/// Callback function for `harfbuzz.faceCreateForTables`.
